...
const file_proto_task_task_proto_rawDesc = "" +
	...
	"\x12DeleteTaskResponse2\x96\x03\n" +
	"\vTaskService\x12?\n" +
	"\n" +
	...
	"\n" +
	"DeleteTask\x12\x17.task.DeleteTaskRequest\x1a\x18.task.DeleteTaskResponseB/Z-github.com/TellSamm/project-protos/proto/taskb\x06proto3"
...
var file_proto_task_task_proto_depIdxs = []int32{
	...
	0,  // 4: task.UpdateTaskRequest.task:type_name -> task.Task
	0,  // 5: task.UpdateTaskResponse.task:type_name -> task.Task
	1,  // 6: task.TaskService.CreateTask:input_type -> task.CreateTaskRequest
	3,  // 7: task.TaskService.GetTask:input_type -> task.GetTaskRequest
	5,  // 8: task.TaskService.ListTasks:input_type -> task.ListTasksRequest
	7,  // 9: task.TaskService.ListTasksByUser:input_type -> task.ListTasksByUserRequest
	9,  // 10: task.TaskService.UpdateTask:input_type -> task.UpdateTaskRequest
	11, // 11: task.TaskService.DeleteTask:input_type -> task.DeleteTaskRequest
	...
	8,  // 15: task.TaskService.ListTasksByUser:output_type -> task.ListTasksByUserResponse
	10, // 16: task.TaskService.UpdateTask:output_type -> task.UpdateTaskResponse
	12, // 17: task.TaskService.DeleteTask:output_type -> task.DeleteTaskResponse
